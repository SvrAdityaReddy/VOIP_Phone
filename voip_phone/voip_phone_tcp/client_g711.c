 ...
 * @create date 2018-04-21 04:09:06
 * @modify date 2018-04-21 04:09:06
 * @desc voip phone client code
*/
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
int main(int argc, char *argv[]) {
    ...
    if(!fork()) {
        ...
        for (;;) {
            ...
            if (loop_write(sfd, coded, sizeof(coded) != sizeof(coded))) {
        ...
        for (;;) {
            ...
            /* ... and play it */
            if (pa_simple_write(s, encoded, sizeof(encoded), &error) < 0) {
